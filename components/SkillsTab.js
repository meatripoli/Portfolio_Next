...
export default (props) => {
    ...
    return(<>
        ...
        <Container className={props.show?'animated fadeIn':'styleBefore'}>
            <h3>FRONT-END</h3>
            <div>
                <OverlayTrigger 
                placement="top"
            ...
            <div>
                ...
                overlay={myTooltip('AJAX')}>
                    <img className='skilsIcon' style={{width:'100px'}} src='/img/ajax.png'/>
                </OverlayTrigger>
                <OverlayTrigger 
                placement="top"
                overlay={myTooltip('Express.js')}>
                    <img className='skilsIcon' style={{width:'100px'}} src='/img/Expressjs.png'/>
                </OverlayTrigger>
                <OverlayTrigger 
                placement="top"
